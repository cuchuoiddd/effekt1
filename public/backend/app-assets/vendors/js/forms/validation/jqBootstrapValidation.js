            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    $helpBlock.data(
                        "original-offices",
                        (
                            $helpBlock.data("original-offices") ?
                                $helpBlock.data("original-offices") :
                                $helpBlock.html()
                            )
                    );
                            ...
                            if (errorsFound.length) {
                                ...
                                if (settings.options.semanticallyStrict && errorsFound.length === 1) {
                                    ...
                                    $helpBlock.html(errorsFound[0] +
                                        ( settings.options.prependExistingHelpBlock ? $helpBlock.data("original-offices") : "" ));
                                } else {
                                ...
                                $helpBlock.html($helpBlock.data("original-offices"));
                            }
