                    ...
                    <div class="card">
                        <div class="card-header fix-header bottom-card">
                            <div class="row" style="align-items: baseline">
                                <h4 class="col-lg-3">Quản lý danh mục</h4>
                            </div>
                        ...
                        <div class="card-content">
                            <form action="{{route('admin.categories.store')}}" method="POST" id="myFormId">
                                @csrf
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ($) {
            ...
            $('.dd').nestable().on('change', function () {
                $.ajax({
                    url: '/admin/work/categories/serialize',
                    type: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}",
