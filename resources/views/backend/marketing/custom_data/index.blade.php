                            ...
                            <div class="card-body">
                                <div class="table-responsive tableFixHead table-bordered table-hover"
                                    ...
                                    <table class="table table-custom">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="text-center"><input type="checkbox" getData value="1"></td>
                                            <td class="text-center">sadfaf111</td>
                                            <td class="text-center">ádf</td>
                                            <td class="text-center">gfhasdf</td>
                                            <td class="text-center">dfag</td>
                                        ...
                                        <tr>
                                            <td class="text-center"><input type="checkbox" getData value="2"></td>
                                            <td class="text-center">sadfaf222</td>
                                            <td class="text-center">ádf</td>
                                            <td class="text-center">gfhasdf</td>
                                            <td class="text-center">dfag</td>
                                            <td class="text-center">
                                        ...
                                        {{--<tr>--}}
                                        {{--<td class="text-center">23w</td>--}}
                                        {{--<td class="text-center">sadfaf</td>--}}
                                        {{--<td class="text-center">ádf</td>--}}
                                        {{--<td class="text-center">gfhasdf</td>--}}
                                        {{--<td class="text-center">dfag</td>--}}
                                        {{--<td class="text-center">--}}
